...
router.post('/register', [
  ...
  try {
    ...
    // Check email uniqueness always; roll/register only for students
    ...
    if (existingUser) {
      return res.status(400).json({
        message: isAdmin
          ...
          : 'User already exists with that email, roll number or register number'
      });
    }
    ...
    // Handle Mongo duplicate key errors with a clean message
